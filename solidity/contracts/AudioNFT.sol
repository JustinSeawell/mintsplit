...
contract AudioNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public allowMintingAfter = 0; // TODO: ??
    ...
    constructor(
        ...
        setBaseURI(_baseUri);
        setNotRevealedURI(_preRevealUri);
    }
...
contract AudioNFTFactory {
    ...
    function createProject(
        ...
        AudioNFT newProject = new AudioNFT({
            _name: name,
            _symbol: symbol,
            _cost: cost,
        ...
        newProject.transferOwnership(msg.sender); // TODO: Find a way to do this in the constructor to avoid gas fees
